...
exports.withGeneratedBaseMods = exports.provider = exports.createPlatformBaseMod = exports.clearMods = exports.assertModResults = exports.createBaseMod = void 0;
...
function clearMods(config, { platform, preserve }) {
    ...
    for (const key of Object.keys(mods[platform] || {})) {
        if (!(preserve === null || preserve === void 0 ? void 0 : preserve.includes(key))) {
            // @ts-ignore
            delete mods[platform][key];
        }
    }
}
exports.clearMods = clearMods;
