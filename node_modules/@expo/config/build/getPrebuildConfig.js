...
function getPrebuildConfig(projectRoot, { platforms, bundleIdentifier, packageName, expoUsername, }) {
    ...
    if (platforms.includes('ios')) {
        ...
        config.ios.bundleIdentifier =
            (_a = bundleIdentifier !== null && bundleIdentifier !== void 0 ? bundleIdentifier : config.ios.bundleIdentifier) !== null && _a !== void 0 ? _a : 'UNDEFINED (invalid)';
    ...
    if (platforms.includes('android')) {
        if (!config.android)
            config.android = {};
        config.android.package = (_b = packageName !== null && packageName !== void 0 ? packageName : config.android.package) !== null && _b !== void 0 ? _b : 'UNDEFINED (invalid)';
        // Add all built-in plugins
